...
extern "C" var priceClose(int bar)
{
  (void)bar;
  return g_dummy_price;
}

extern "C" vars series(var source)
{
  (void)source;
  return g_dummy_series_buffer;
}

extern "C" void plot(string label,var value,int style,int color)
{
  (void)label;
  (void)value;
  (void)style;
...
extern "C" void enterLong(void)
{
}

extern "C" void enterShort(void)
{
}

#include "../../src/cpp64/aa_arima_all_64.cpp"
